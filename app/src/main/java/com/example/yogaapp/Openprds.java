...
public class Openprds extends AppCompatActivity {
    String buttonvalue;
    Button startBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_openprds);
        ...
        switch (intvalue){
            case 1 :
                ...
                break;
            case 2 :
                setContentView(R.layout.spl3);
                description = getString(R.string.spose3);
                break;
            case 3 :
                ...
                break;
            case 4 :
                setContentView(R.layout.spl10);
                description = getString(R.string.spose10);
                break;
            case 5 :
                setContentView(R.layout.spl11);
                description = getString(R.string.spose11);
                break;
            default:
    ...
    private void startTimer(){
        ...
        countDownTimer = new CountDownTimer(MTimeLeftinmillis, 1000) {
            ...
            public void onFinish() {
                ...
                if (newvalue <= 5){
                    Intent intent = new Intent(Openprds.this, Openprds.class);
                    ...
                    newvalue = 1;
                    Intent intent = new Intent(Openprds.this,Periods.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    intent.putExtra("value",String.valueOf(newvalue));
                    startActivity(intent);
                }
