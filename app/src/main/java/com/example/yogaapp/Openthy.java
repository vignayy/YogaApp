...
public class Openthy extends AppCompatActivity {
    String buttonvalue;
    Button startBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_openthy);
        ...
        switch (intvalue){
            ...
            case 2 :
                ...
                description = getString(R.string.apose21);
                break;
            case 3 :
            ...
            case 4 :
                ...
                break;
            case 5 :
                setContentView(R.layout.spl2);
                description = getString(R.string.spose2);
                break;
            default:
    ...
    private void startTimer(){
        ...
        countDownTimer = new CountDownTimer(MTimeLeftinmillis, 1000) {
            ...
            public void onFinish() {
                ...
                if (newvalue <= 5){
                    Intent intent = new Intent(Openthy.this, Openthy.class);
                    ...
                    newvalue = 1;
                    Intent intent = new Intent(Openthy.this,Thyroid.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    intent.putExtra("value",String.valueOf(newvalue));
                    startActivity(intent);
                }
