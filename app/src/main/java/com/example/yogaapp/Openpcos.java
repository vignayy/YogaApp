...
public class Openpcos extends AppCompatActivity {
    String buttonvalue;
    Button startBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_openpcos);
        ...
        switch (intvalue){
            ...
            case 4 :
                ...
                break;
            case 5 :
                setContentView(R.layout.spl5);
                description = getString(R.string.spose5);
                break;
            default:
    ...
    private void startTimer(){
        ...
        countDownTimer = new CountDownTimer(MTimeLeftinmillis, 1000) {
            ...
            public void onFinish() {
                ...
                if (newvalue <= 5){
                    Intent intent = new Intent(Openpcos.this, Openpcos.class);
                    ...
                    newvalue = 1;
                    Intent intent = new Intent(Openpcos.this,Pcos.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    intent.putExtra("value",String.valueOf(newvalue));
                    startActivity(intent);
                }
