...
public class Open3b extends AppCompatActivity {
    String buttonvalue;
    Button startBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_open3b);
        ...
        switch (intvalue){
            case 1 :
                setContentView(R.layout.cln1);
                description = getString(R.string.cpose1);
                break;
            case 2 :
                setContentView(R.layout.cln2);
                description = getString(R.string.cpose2);
                break;
            case 3 :
                setContentView(R.layout.cln3);
                description = getString(R.string.cpose3);
                break;
            case 4 :
                setContentView(R.layout.cln4);
                description = getString(R.string.cpose4);
                break;
            case 5 :
                setContentView(R.layout.cln5);
                description = getString(R.string.cpose5);
                break;
            case 6 :
                setContentView(R.layout.cln6);
                description = getString(R.string.cpose6);
                break;
            case 7 :
                setContentView(R.layout.cln7);
                description = getString(R.string.cpose7);
                break;
            case 8 :
                setContentView(R.layout.cln8);
                description = getString(R.string.cpose8);
                break;
            default:
    ...
    private void startTimer(){
        ...
        countDownTimer = new CountDownTimer(MTimeLeftinmillis, 1000) {
            ...
            public void onFinish() {
                ...
                if (newvalue <= 8){
                    Intent intent = new Intent(Open3b.this, Open3b.class);
                    ...
                    newvalue = 1;
                    Intent intent = new Intent(Open3b.this,Cleansing3.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    intent.putExtra("value",String.valueOf(newvalue));
                    startActivity(intent);
                }
